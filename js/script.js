window.addEventListener('DOMContentLoaded', () => {
	...
	// даелаем асинхронный код синхронным с помощью async/await
	// async/await используются в паре
	...
	//Fetch API DOM API
	//Fetch API уже встроенн в браузер, он позволяет общаться с сервером
	// и построена на Promise 
	...
	// 			'Content-type': 'application/json'
	// 		}
	// 	}) //из этой конструкции возвращаеться promise
